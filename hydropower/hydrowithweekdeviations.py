...
# Deviations from the historical values
reslevdeviations = {}
for g in hydroind:
...
store = pd.HDFStore('hydroweekdevstore.h5')

# Save the data in the store
# store['windprodweekdev12'] = df_windprod
# store['solarprodweekdev12'] = df_solarprod
# store['genprodweekdev12'] = df_genprod
# store['loadshedweekdev12'] = df_loadshed
# store['flowweekdev12'] = df_flow
# store['p_exchweekdev12'] = df_p_exch
# store['hydroprodweekdev12'] = df_hydro
# store['downdeviationweekdev12'] = df_down_dev
# store['updeviationweekdev12'] = df_up_dev
# store['priceweekdev12'] = df_oldprice
# store['reservlevelweekdev12'] = df_res_lev
# store['hydroproductionweekdev12'] = df_hydroprod
# store['countryhydroweekdev12'] = df_country_hydro
# store['hydrospillweekdev12'] = df_hydrospill
# store['countryhydrospillweekdev12'] = df_country_hydrospill


# store['windprodweekdev13'] = df_windprod
# store['solarprodweekdev13'] = df_solarprod
# store['genprodweekdev13'] = df_genprod
# store['loadshedweekdev13'] = df_loadshed
# store['flowweekdev13'] = df_flow
# store['p_exchweekdev13'] = df_p_exch
# store['hydroprodweekdev13'] = df_hydro
# store['downdeviationweekdev13'] = df_down_dev
# store['updeviationweekdev13'] = df_up_dev
# store['priceweekdev13'] = df_oldprice
# store['reservlevelweekdev13'] = df_res_lev
# store['hydrospillweekdev13'] = df_country_hydrospill
